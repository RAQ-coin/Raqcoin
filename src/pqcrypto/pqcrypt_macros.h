#ifndef RAQCOIN_PQCRYPT_MACROS_H
#define RAQCOIN_PQCRYPT_MACROS_H
...
#elif !defined(__STRICT_ANSI__) && defined(__GNUC__) && (defined(__i386__) || defined(__x86_64__)) && !defined(INTEL_CC) && !defined(PQC_NO_ASM)
#define PQC_ROx_ASM
...
/* 64-bit Rotates */
#if !defined(__STRICT_ANSI__) && defined(__GNUC__) && defined(__x86_64__) && !defined(_WIN64) && !defined(PQC_NO_ASM)
...
#ifndef PQC_UNUSED_PARAM
   #define PQC_UNUSED_PARAM(x) (void)(x)
#endif
