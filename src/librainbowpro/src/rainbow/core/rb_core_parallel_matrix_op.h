...
void rb_UpperTrianglize(rb_handle handle, unsigned char * btriC , const unsigned char * bA , unsigned int Awidth, unsigned int size_batch );
...
void rb_batch_trimatTr_madd_gf16(rb_handle handle, unsigned char * bC , const unsigned char* btriA ,const unsigned char* B , unsigned int Bheight, unsigned int size_Bcolvec , unsigned int Bwidth, unsigned int size_batch );

void rb_batch_trimatTr_madd_gf256(rb_handle handle, unsigned char * bC , const unsigned char* btriA ,
        const unsigned char* B , unsigned int Bheight, unsigned int size_Bcolvec , unsigned int Bwidth, unsigned int size_batch );

void rb_batch_2trimat_madd_gf16(rb_handle handle, unsigned char * bC , const unsigned char* btriA ,
        const unsigned char* B , unsigned int Bheight, unsigned int size_Bcolvec , unsigned int Bwidth, unsigned int size_batch );

void rb_batch_2trimat_madd_gf256(rb_handle handle, unsigned char * bC , const unsigned char* btriA ,
        const unsigned char* B , unsigned int Bheight, unsigned int size_Bcolvec , unsigned int Bwidth, unsigned int size_batch );

void rb_batch_matTr_madd_gf16(rb_handle handle, unsigned char * bC ,
...
void rb_batch_matTr_madd_gf256(rb_handle handle, unsigned char * bC ,
        const unsigned char* A_to_tr , unsigned int Aheight, unsigned int size_Acolvec, unsigned int Awidth,
        const unsigned char* bB, unsigned int Bwidth, unsigned int size_batch );
...
void rb_batch_quad_recmat_eval_gf16(rb_handle handle, unsigned char * z, const unsigned char * y, unsigned int dim_y,
        const unsigned char * mat, const unsigned char * x, unsigned int dim_x , unsigned int size_batch );

void rb_batch_quad_recmat_eval_gf256(rb_handle handle, unsigned char * z, const unsigned char * y, unsigned int dim_y,
        const unsigned char * mat, const unsigned char * x, unsigned int dim_x , unsigned int size_batch );
