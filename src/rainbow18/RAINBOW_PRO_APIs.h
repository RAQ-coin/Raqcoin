...
#if defined(WIN32_VERSION) || defined(WIN32) || defined(_WIN32)
#ifndef RBPROCALL
...
// Use pointer-sized handle to avoid truncation on 64-bit builds.
...
RBPROCALL rainbowplus_choised_check_len(unsigned int type,/*1:sk,2:pk,3:signsize,4:hashsize,0:guess*/unsigned int len);
