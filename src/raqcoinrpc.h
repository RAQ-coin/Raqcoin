...
enum RPCErrorCode
{
    ...
    RPC_WALLET_KEYPOOL_RAN_OUT      = -12, // Keypool ran out, call getnewaddress first
...
extern int GetDifficulty(const CBlockIndex* blockindex = NULL);
...
extern json_spirit::Value dumpkey(const json_spirit::Array& params, bool fHelp); // in rpcdump.cpp
extern json_spirit::Value importkey(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getpublickeypos(const json_spirit::Array& params, bool fHelp);
