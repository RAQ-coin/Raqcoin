...
#ifndef RAQCOIN_MAIN_H
#define RAQCOIN_MAIN_H
...
static const int64 MAX_MONEY = 2147483647 * COIN;
...
extern uint64 nBestChainWork;
extern uint64 nBestInvalidWork;
...
public:
    ...
    */
    ...
    /** Amount of raqcoins spent by this transaction.
    ...
    /** Amount of raqcoins coming in to this transaction
 ...
 *               * 8358: compact amount representation for 60000000000 (600 ABC)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 ABC)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 ABC)
 *              * 00: special txout type pay-to-pubkey-hash
...
public:
    ...
    void SetNull()
    {
        nVersion = BLOCK_CURRENT_VERSION;
        hashPrevBlock = 0;
        hashMerkleRoot = 0;
        nTime = 0;
        nBits = 0;
...
public:
    ...
    void print() const
    {
        printf("CBlock(hash=%s, ver=%d, hashPrevBlock=%s, hashMerkleRoot=%s, nTime=%u, nBits=%08x, nNonce=%s, vtx=%" PRIszu ")\n",
            GetHash().ToString().c_str(),
            nVersion,
