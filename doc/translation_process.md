...
`src/qt/locale/raqcoin_en.ts` is treated in a special way. It is used as the
...
Ubuntu/Debian):
    ...
    lupdate raqcoin-qt.pro -no-obsolete -locations relative -ts src/qt/locale/raqcoin_en.ts
    
##### Handling of plurals in the source file

When new plurals are added to the source file, it's important to do the following steps:

1. Open raqcoin_en.ts in Qt Linguist (also included in the Qt SDK)
...
To create the pull-request you have to do:
    ...
    git add src/qt/raqcoinstrings.cpp src/qt/locale/raqcoin_en.ts
    git commit
