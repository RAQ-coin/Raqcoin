...
unlocked to sign the Raqcoin-Qt.app bundle.
...
allowing somebody to distribute a Raqcoin-Qt.app or raqcoin-qt-setup.exe with a valid
...
that the raqcoin-qt.exe file inside the installer had not been tampered with.
